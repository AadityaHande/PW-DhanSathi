          ...
          <nav className="flex items-center space-x-1">
            {navItems.map((item) => {
              const isActive = pathname === item.href || 
                (item.href === "/goals/new" && pathname.startsWith("/goals"));
              return (
                <Link
                  key={item.href}
                  href={item.href}
      ...
      <AlertDialog open={showDisconnectDialog} onOpenChange={setShowDisconnectDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to disconnect your wallet? You will need to reconnect to access your goals and savings.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
